...
public class LinkedPositionalList<E> implements PositionalList<E> {
  ...
  public int indexOf(String s) {
      int index = 0;
      for (Node<E> current = header.getNext(); current != trailer; current = current.getNext()) {
  ...
  public static void main(String[] args) {
	  ...
	  list.addLast("Hello");
	  list.addLast("Goodnight");
	  System.out.println("Index is: " + list.indexOf("Goodnight"));
	  System.out.println("Index is: " + list.indexOf("Hello"));
	  System.out.println("Index is: " + list.indexOf("Goodnight"));
	}
